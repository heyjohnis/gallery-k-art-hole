  ...
  return (
    <div>
      <ul className='detail_menu'>
        <li><Link href="#product">상품소개</Link></li>
        <li><Link href="#delivery">배송문의</Link></li>
      </ul>
      <div className='products_detail'>
        <div id="product" className='detail_item'>
          <img src="/images/ggshopping/product_item_01.png"/>
          <img src="/images/ggshopping/product_item_02.png"/>
        </div>
        <div id="delivery" className='detail_item'>
          <h2>배송문의</h2>
          <img src="/images/ggshopping/product_delivery_01.png"/>
        </div>
        <div id="delivery" className='detail_item'>
          <h2>추천상품 <span>3</span></h2>
          <Swiper
          slidesPerView={2}
          spaceBetween={30}
          grabCursor={true}
