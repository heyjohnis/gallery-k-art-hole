...
const PrivacyPolicyText = () => {
  return (
    <>
      <h5>1. 개인정보의 처리 목적</h5>
      <p>
        {"<"}그린갤러리{">"}(‘http://greengallery.kr‘ 이하 ‘그린갤러리
        골프멤버십’)은(는) 다음의 목적을 위하여 개인정보를 처리하고 있으며,
        다음의 목적 이외의 용도로는 이용하지 않습니다. <br />- 고객 가입의사
        확인, 고객에 대한 서비스 제공에 따른 본인 식별.인증, 회원자격 유지.관리,
        물품 또는 서비스 공급에 따른 금액 결제, 물품 또는 서비스의 공급.배송 등
      </p>

      <h5>2. 개인정보의 처리 및 보유 기간</h5>
      <p>
        ①{"<"}그린갤러리{">"}(‘greengallery.kr’이하 ‘그린갤러리
        골프멤버십’)은(는) 정보주체로부터 개인정보를 수집할 때 동의 받은
      ...
      <p>
        ① {"<"}그린갤러리{">"}(‘greengallery.kr’이하 ‘그린갤러리
        골프멤버십’)은(는) 정보주체의 동의, 법률의 특별한 규정 등 개인정보
        보호법 제17조 및 제18조에 해당하는 경우에만 개인정보를 제3자에게
        제공합니다.
        <br />② {"<"}그린갤러리{">"}('greengallery.kr')은(는) 다음과 같이
        ...
        - 개인정보를 제공받는 자 : 그린갤러리
        <br />
        - 제공받는 자의 개인정보 이용목적 : 이메일, 휴대전화번호, 자택주소,
        비밀번호, 로그인ID, 성별, 생년월일, 이름
        <br />
        - 제공받는 자의 보유.이용기간: 3년
        <br />
      </p>
      ...
      <h5>4. 개인정보처리 위탁</h5>
      <p>
        ① {"<"}그린갤러리{">"}(‘그린갤러리 골프멤버십’)은(는) 원활한 개인정보
        ...
        <br />- 위탁하는 업무의 내용 :
        <br />- 위탁기간 :
        <br />② {"<"}그린갤러리{">"}('greengallery.kr'이하 '그린갤러리
        골프멤버십')은(는) 위탁계약 체결시 개인정보 보호법 제25조에 따라
        위탁업무 수행목적 외 개인정보 처리금지, 기술적․관리적 보호조치, 재위탁
        제한, 수탁자에 대한 관리․감독, 손해배상 등 책임에 관한 사항을 계약서 등
      ...
      <p>
        ① 정보주체는 그린갤러리(‘[greengallery.kr](http://greengallery.kr/)’이하
        ‘그린갤러리 골프멤버십’) 에 대해 언제든지 다음 각 호의 개인정보 보호
        관련 권리를 행사할 수 있습니다.
        <br />
        1. 개인정보 열람요
        <br />
      ...
      <p>
        ① {"<"}그린갤러리{">"}(‘greengallery.kr’이하 ‘그린갤러리
        골프멤버십’)은(는) 다음의 개인정보 항목을 처리하고 있습니다
        <br />
        1. {"<"}그린갤러리{">"}
        <br />- 필수항목 : 이메일, 휴대전화번호, 비밀번호, 로그인ID, 성별,
        생년월일, 이름
        <br />- 선택항목 : 회사전화번호, 직책, 부서, 회사명, 직업, 기념일,
        결혼여부, 취미, 신체정보, 학력, 종교
      </p>

      <h5>
        7. 개인정보의 파기 {"<"}그린갤러리{">"}('그린갤러리 골프멤버십')은(는)
        원칙적으로 개인정보 처리목적이 달성된 경우에는 지체없이 해당 개인정보를
      ...
      <p>
        ① 그린갤러리는 개별적인 맞춤서비스를 제공하기 위해 이용정보를 저장하고
        ...
        쿠키의 설치
        <br />
        •운영 및 거부 : 웹브라우저 상단의 도구{">"} 인터넷 옵션{">"} 개인정보
      ...
      <p>
        ① 그린갤러리(‘[greengallery.kr](http://greengallery.kr/)’이하
        ‘그린갤러리 골프멤버십’) 은(는) 개인정보 처리에 관한 업무를 총괄해서
        ...
        골프멤버십’) 의 서비스(또는 사업)을 이용하시면서 발생한 모든 개인정보
        보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자
        및 담당부서로 문의하실 수 있습니다.
        <br />
        그린갤러리(‘[greengallery.kr](http://greengallery.kr/)’이하 ‘그린갤러리
        골프멤버십’) 은(는) 정보주체의 문의에 대해 지체 없이 답변 및 처리해드릴
        것입니다.
      </p>
      ...
      <h5>
        11. 개인정보의 안전성 확보 조치 {"<"}그린갤러리{">"}('그린갤러리
        골프멤버십')은(는) 개인정보보호법 제29조에 따라 다음과 같이 안전성
        확보에 필요한 기술적/관리적 및 물리적 조치를 하고 있습니다.
      </h5>
      <p>
        1. 정기적인 자체 감사 실시개인정보 취급 관련 안정성 확보를 위해
        정기적(분기 1회)으로 자체 감사를 실시하고 있습니다.
        <br />
        2. 개인정보 취급 직원의 최소화 및 교육개인정보를 취급하는 직원을
        지정하고 담당자에 한정시켜 최소화 하여 개인정보를 관리하는 대책을
        시행하고 있습니다.
        <br />
        3. 내부관리계획의 수립 및 시행개인정보의 안전한 처리를 위하여
        내부관리계획을 수립하고 시행하고 있습니다.
        <br />
        4. 해킹 등에 대비한 기술적 대책{"<"}그린갤러리{">"}('그린갤러리
        골프멤버십')은 해킹이나 컴퓨터 바이러스 등에 의한 개인정보 유출 및
        훼손을 막기 위하여 보안프로그램을 설치하고 주기적인 갱신·점검을 하며
        외부로부터 접근이 통제된 구역에 시스템을 설치하고 기술적/물리적으로 감시
        및 차단하고 있습니다.
        <br />
        5. 개인정보의 암호화이용자의 개인정보는 비밀번호는 암호화 되어 저장 및
        관리되고 있어, 본인만이 알 수 있으며 중요한 데이터는 파일 및 전송
        데이터를 암호화 하거나 파일 잠금 기능을 사용하는 등의 별도 보안기능을
        사용하고 있습니다.
        <br />
        6. 접속기록의 보관 및 위변조 방지개인정보처리시스템에 접속한 기록을 최소
        6개월 이상 보관, 관리하고 있으며, 접속 기록이 위변조 및 도난, 분실되지
        않도록 보안기능 사용하고 있습니다.
        <br />
        7. 개인정보에 대한 접근 제한개인정보를 처리하는 데이터베이스시스템에
        대한 접근권한의 부여,변경,말소를 통하여 개인정보에 대한 접근통제를
        위하여 필요한 조치를 하고 있으며 침입차단시스템을 이용하여 외부로부터의
        무단 접근을 통제하고 있습니다.
        <br />
        8. 문서보안을 위한 잠금장치 사용개인정보가 포함된 서류, 보조저장매체
        등을 잠금장치가 있는 안전한 장소에 보관하고 있습니다.
        <br />
        9. 비인가자에 대한 출입 통제개인정보를 보관하고 있는 물리적 보관 장소를
      ...
      <p>
        ...
        부서에 할 수 있습니다. {"<"}그린갤러리{">"}
        (‘[greengallery.kr](http://greengallery.kr/)'이하 '그린갤러리
        골프멤버십')은(는) 정보주체의 개인정보 열람청구가 신속하게 처리되도록
        노력하겠습니다.
      ...
      <p>
        ...
        {"<"}그린갤러리{">"}(‘[greengallery.kr](http://greengallery.kr/)'이하
        '갤러리케이 아트노믹스')
        <br />의 자체적인 개인정보 불만처리, 피해구제 결과에 만족하지 못하시거나
