  ...
  return (
    <>
      ...
      <li>
        ...
        <span className="list_item">
          {user.monthly_count * 3 - (user.use_qaurterly_count || 0)}회 /{" "}
          {user.monthly_count * 3}회
        </span>
      </li>
      <li>
        <span className="list_tit">
        ...
        <span className="list_item">
          {user.monthly_count * 3 - (user.use_next_qaurterly_count || 0)} 회 /{" "}
          {user.monthly_count * 3}회
        </span>
      </li>
      <li>
        ...
        <span className="list_item">
          {user.monthly_count * 6 - (user.use_qaurterly_count || 0)} 회 /{" "}
          {user.monthly_count * 6}회
        </span>
      </li>
      <li>
        <span className="list_tit">
        ...
        <span className="list_item">
          {user.monthly_count * 6 - (user.use_next_qaurterly_count || 0)} 회 /{" "}
          {user.monthly_count * 6}회
        </span>
      </li>
      <li>
