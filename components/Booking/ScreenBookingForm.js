  ...
  return (
    <div className='booking_content'>
      ...
      <ul className='booking_notice'>
        ...
        <li>ㆍ카카오톡 또는 유선 전화를 통해 승인완료 문자를 수신해드립니다.</li>
        <li>ㆍ승인 완료 문자 미수신 또는 승인 거절 시 서비스 이용 불가합니다.</li>
        <li>ㆍ콜센터를 통해 사용 신청 당일 내에 확인 받으셔야 서비스 진행이 이루어집니다.</li>
      </ul>
      ...
      <Form>
        ...
        <div className='form_item'>
          ...
          <Form.Control as="textarea" rows={3} placeholder="문의하실 요청사항을 작성해주세요."/>
        </div>
