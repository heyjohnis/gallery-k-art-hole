        ...
        <Table bordered className={styles.table_membership}>
          <tbody>
            ...
            <tr>
              <th>계약자 연락처</th>
              <td>
                {hyphenForPhone(user.mobile || "")}{" "}
                {user.phone ? `(${hyphenForPhone(user.phone)})` : ""}
              </td>
            </tr>
            <tr>
              <th>계약자 이메일</th>
            ...
            {user.user_kind != "01" && (
              <>
                ...
                <tr>
                  <th>사업자번호</th>
                  <td>{hyphenForCorpNum(user.corp_ssn || "")}</td>
                </tr>
              </>
            )}
          </tbody>
              ...
              <tbody>
                {artworks.map((artwork, i) => (
                  <tr key={i}>
                    <td>
                      <img
                        src={`https://www.artnomics.co.kr/data/artworks/${artwork.atwk_no}/thumb-image_100.jpg`}
                      />
                    </td>
                    <td>
                      {artwork.atwk_nm}/ {artwork.atst_nm}/ {artwork.atwk_resc}/{" "}
                      {artwork.atwk_size_no}호 / {artwork.atwk_make_year}년
                    </td>
