...
const MyLevel = ({ user }) => {
  ...
  switch (user.membership) {
    case "green":
      membershipStyle = styles.green;
      break;
    case "red":
      membershipStyle = styles.red;
      break;
    case "blue":
      membershipStyle = styles.blue;
      break;
    case "purple":
      membershipStyle = styles.purple;
      break;
    case "black":
      membershipStyle = styles.black;
      break;
    case "platinum":
      membershipStyle = styles.platinum;
      break;
  }
